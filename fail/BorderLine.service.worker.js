...
/** @type {string} */
const CACHE_VERSION = '1769539721|4207348768';
/** @type {string} */
const CACHE_PREFIX = 'BorderLine-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BorderLine.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BorderLine.html","BorderLine.js","BorderLine.offline.html","BorderLine.icon.png","BorderLine.apple-touch-icon.png","BorderLine.audio.worklet.js","BorderLine.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BorderLine.wasm","BorderLine.pck"];
